...
int main(int argc, char **argv) {
  ...
  std::string data2D_tensor_filename = "tools/marvin/TMPdata2D.tensor";
  std::string data3D_tensor_filename = "tools/marvin/TMPdata3D.tensor";
  std::string label_tensor_filename = "tools/marvin/TMPlabels.tensor";
  ...
  std::string class_score_tensor_filename = "TMPclass_score_response.tensor";
  ...
  for (int i = 0; i < num_hypotheses * 2; i++)
    std::cout << class_score_raw[i] << std::endl;
